    ...
    class e {
        ...
        static calculateControlPoints(e, i, n) {
            const s = e.x - i.x,
                ...
                g = i.x - _,
                x = i.y - p;
            return { c1: new t(a + g, d + x), c2: new t(l + g, c + x) };
        }
        length() {
            let t,
                e,
    ...
    class i extends EventTarget {
        constructor(t, e = {}) {
            super(),
                ...
                (this._handleMouseDown = (t) => {
                    1 === t.buttons &&
                        ((this._drawningStroke = !0), this._strokeBegin(t));
                }),
                ...
                (this._handleMouseUp = (t) => {
                    1 === t.buttons &&
                        this._drawningStroke &&
                        ((this._drawningStroke = !1), this._strokeEnd(t));
                }),
                ...
                (this._handlePointerMove = (t) => {
                    this._drawningStroke &&
                        (t.preventDefault(), this._strokeMoveUpdate(t));
                }),
                              ...
                              return (
                                  ...
                                  l <= 0 || l > e
                                      ? (h && (clearTimeout(h), (h = null)),
                                        ...
                                        (i = t.apply(n, s)),
                                        h || ((n = null), (s = [])))
                                      : h || (h = window.setTimeout(r, l)),
                                  i
                              );
                          };
                      })(i.prototype._strokeUpdate, this.throttle)
                    : i.prototype._strokeUpdate),
        ...
        fromDataURL(t, e = {}) {
            return new Promise((i, n) => {
                ...
                this._reset(),
                    (s.onload = () => {
                        this._ctx.drawImage(s, a, d, h, r), i();
                    }),
                    (s.onerror = (t) => {
                        n(t);
                    }),
        ...
        fromData(t, { clear: e = !0 } = {}) {
            e && this.clear(),
                ...
                (this._data = e ? t : this._data.concat(t));
        }
        toData() {
            return this._data;
        }
        ...
        _strokeUpdate(t) {
            ...
            const e = t.clientX,
                ...
                a = !!r && s.distanceTo(r) <= this.minDistance,
                { penColor: d, dotSize: l, minWidth: c, maxWidth: u } = o;
            if (!r || !r || !a) {
        ...
        _addPoint(t) {
            ...
            if ((i.push(t), i.length > 2)) {
                ...
                const t = this._calculateCurveWidths(i[1], i[2]),
                    n = e.fromPoints(i, t);
                return i.shift(), n;
            }
            return null;
        ...
        _calculateCurveWidths(t, e) {
            const i =
                ...
                n = this._strokeWidth(i),
                s = { end: n, start: this._lastWidth };
            return (this._lastVelocity = i), (this._lastWidth = n), s;
        }
        _strokeWidth(t) {
        ...
        _drawCurve(t, e) {
            ...
            for (let i = 0; i < s; i += 1) {
                const o = i / s,
                    ...
                    d = a * a,
                    l = d * a;
                let c = l * t.startPoint.x;
                (c += 3 * d * o * t.control1.x),
                    (c += 3 * a * h * t.control2.x),
                    (c += r * t.endPoint.x);
                let u = l * t.startPoint.y;
                (u += 3 * d * o * t.control1.y),
                    (u += 3 * a * h * t.control2.y),
                    (u += r * t.endPoint.y);
                const v = Math.min(t.startWidth + r * n, e.maxWidth);
            ...
            for (const s of e) {
                ...
                if (a.length > 1)
                    for (let n = 0; n < a.length; n += 1) {
                        const s = a[n],
                            d = new t(s.x, s.y, s.pressure, s.time);
                        (this.penColor = e), 0 === n && this._reset();
                        const l = this._addPoint(d);
                        l &&
                            i(l, {
                                penColor: e,
                                dotSize: o,
        ...
        _toSVG() {
                ...
                this._fromData(
                    ...
                    (t, { penColor: e }) => {
                        ...
                        if (
                            ...
                            const n = `M ${t.startPoint.x.toFixed(
                                3
                            )},${t.startPoint.y.toFixed(
                                3
                            )} C ${t.control1.x.toFixed(
                                3
                            )},${t.control1.y.toFixed(
                                3
                            )} ${t.control2.x.toFixed(
                                3
                            )},${t.control2.y.toFixed(
                                3
                            )} ${t.endPoint.x.toFixed(
                                3
                    ...
                    (
                        t,
                        { penColor: e, dotSize: i, minWidth: n, maxWidth: o }
                    ) => {
            ...
            const o = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 ${this.canvas.width} ${this.canvas.height}" width="${i}" height="${n}">`;
            let h = s.innerHTML;
            if (void 0 === h) {
            ...
            return "data:image/svg+xml;base64," + btoa(o + h + "</svg>");
        }
    }
    return i;
});
